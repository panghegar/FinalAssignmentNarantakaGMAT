...
public class AppleClassifierTraining {
    static {
    ...
    public static void main(String[] args) {
        // Direktori dataset
        File appelDir = new File("imagesCV/data/test/apple");
        ...
        processCategory(appelDir, descriptors, labels, 1);
        ...
        // Simpan model
        svm.save("apple_classifier.xml");
        System.out.println("Model training complete and saved as 'apple_classifier.xml'.");
    }
